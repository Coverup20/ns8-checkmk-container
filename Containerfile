...
#   podman build --build-arg CMK_AGENT_URL=https://monitor.nethlab.it/monitoring/check_mk/agents -t checkmk-agent:latest .
# The agent version is auto-detected from the server agents listing.
ARG CMK_AGENT_URL=https://monitor.nethlab.it/monitoring/check_mk/agents
